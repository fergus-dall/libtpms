...
#define ECC_CURVES							\
    {TPM_ECC_BN_P256,   TPM_ECC_BN_P638,   TPM_ECC_NIST_P192,		\
     ...
     TPM_ECC_NIST_P521, TPM_ECC_SM2_P256,  TPM_ECC_BP_P256_R1,		\
     TPM_ECC_BP_P384_R1,TPM_ECC_BP_P512_R1}
#define ECC_CURVE_COUNT							\
    (ECC_BN_P256   + ECC_BN_P638   + ECC_NIST_P192 + ECC_NIST_P224 +	\
     ...
     ECC_BP_P256_R1 + ECC_BP_P384_R1 + ECC_BP_P512_R1)
#define MAX_ECC_KEY_BITS						\
    ...
    MAX(ECC_BP_P256_R1 * 256, MAX(ECC_BP_P384_R1 * 384, \
    MAX(ECC_BP_P512_R1 * 512, 0)))))))))))
